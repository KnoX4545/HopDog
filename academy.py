# academy.py - نسخه کامل با همه متغیرها
...
# ================================================================
# سیستم هاپویی - سطوح کاربران (۴ صفحه)
# ================================================================
...
┘─ ریپلای کردن روی پیام اون کاربر┘─ نوشتن یوزرنیم (با @ یا بدون @)
...
┘─ ⌛️ بعد از هر انتقال باید *5 دقیقه* صبر کنی تا دوباره بتونی انتقال انجام بدی
...
🔒 تا زمانی که در زندان هستی، فقط دستورات زیر کار میکنه:
...
async def show_academy_main(update, query=None):
    ...
    try:
        ...
        logger.info(f"📚 آکادمی نمایش داده شد")
