# config.py - تنظیمات و ثابت‌های اصلی (نسخه کامل)
...
# ================================================================
# هزینه ارتقا سطح هاپو (طبق عکس) - بر اساس سطح کل (1 تا 25)
# ================================================================

HAPO_LEVEL_PRICES = {
    # ===== مقام 0 (تازه‌وارد) - سطح کل 1 تا 5 =====
    1: 250,      # سطح 1 → 2
    2: 500,      # سطح 2 → 3
    3: 5000,     # سطح 3 → 4
    4: 15000,    # سطح 4 → 5
    
    # ===== مقام 1 (حرفه‌ای) - سطح کل 6 تا 10 =====
    5: 75000,    # سطح 1 → 2 (بعد از ارتقا مقام)
    6: 150000,   # سطح 2 → 3
    7: 250000,   # سطح 3 → 4
    8: 500000,   # سطح 4 → 5
    9: 750000,   # سطح 5 → 6
    ...
    # ===== مقام 2 (استاد) - سطح کل 11 تا 15 =====
    14: 5000000, # سطح 1 → 2 (بعد از ارتقا مقام)
    15: 7500000, # سطح 2 → 3
    16: 10000000, # سطح 3 → 4
    17: 15000000, # سطح 4 → 5
    18: 20000000, # سطح 5 → 6
    ...
    20: 30000000, # سطح 7 → 8
    21: 35000000, # سطح 8 → 9
    22: 40000000, # سطح 9 → 10
    23: 45000000, # سطح 10 → 11
    24: 50000000, # سطح 11 → 12
    25: 60000000, # سطح 12 → 13
    26: 70000000, # سطح 13 → 14
    27: 80000000, # سطح 14 → 15
    
    # ===== مقام 3 (افسانه) - سطح کل 16 تا 20 =====
    28: 90000000, # سطح 1 → 2 (بعد از ارتقا مقام)
    29: 100000000, # سطح 2 → 3
    30: 120000000, # سطح 3 → 4
    31: 140000000, # سطح 4 → 5
    32: 160000000, # سطح 5 → 6
    33: 180000000, # سطح 6 → 7
    34: 200000000, # سطح 7 → 8
    35: 220000000, # سطح 8 → 9
    36: 240000000, # سطح 9 → 10
    37: 260000000, # سطح 10 → 11
    38: 280000000, # سطح 11 → 12
    39: 300000000, # سطح 12 → 13
    40: 320000000, # سطح 13 → 14
    41: 340000000, # سطح 14 → 15
    42: 360000000, # سطح 15 → 16
    43: 380000000, # سطح 16 → 17
    44: 400000000, # سطح 17 → 18
    45: 420000000, # سطح 18 → 19
    46: 440000000, # سطح 19 → 20
    
    # ===== مقام 4 (بی‌نهایت) - سطح کل 21 تا 25 =====
    47: 460000000, # سطح 1 → 2 (بعد از ارتقا مقام)
    48: 480000000, # سطح 2 → 3
    49: 500000000, # سطح 3 → 4
    50: 520000000, # سطح 4 → 5
    51: 540000000, # سطح 5 → 6
    52: 560000000, # سطح 6 → 7
    53: 580000000, # سطح 7 → 8
    54: 600000000, # سطح 8 → 9
    55: 620000000, # سطح 9 → 10
    56: 640000000, # سطح 10 → 11
    57: 660000000, # سطح 11 → 12
    58: 680000000, # سطح 12 → 13
    59: 700000000, # سطح 13 → 14
    60: 720000000, # سطح 14 → 15
    61: 740000000, # سطح 15 → 16
    62: 760000000, # سطح 16 → 17
    63: 780000000, # سطح 17 → 18
    64: 800000000, # سطح 18 → 19
    65: 820000000, # سطح 19 → 20
    66: 840000000, # سطح 20 → 21
    67: 860000000, # سطح 21 → 22
    68: 880000000, # سطح 22 → 23
    69: 900000000, # سطح 23 → 24
    70: 920000000, # سطح 24 → 25
}
