# bot.py - فایل اصلی بات تلگرام (نسخه نهایی با پشتیبانی از Railway Volume)
...
# ✅ راه‌حل نهایی برای ذخیره‌سازی در Railway
# اولویت ۱: از متغیر محیطی DATA_DIR استفاده کن
# اولویت ۲: از پوشه /data استفاده کن (اگر Volume ساخته باشی)
# اولویت ۳: از پوشه /app/data استفاده کن (داخل خود اپلیکیشن)
DATA_DIR = os.environ.get("DATA_DIR")
if not DATA_DIR:
    # اگر Volume ساخته شده، از /data استفاده کن
    if os.path.exists("/data"):
        DATA_DIR = "/data"
    else:
        # در غیر این صورت از پوشه محلی استفاده کن
